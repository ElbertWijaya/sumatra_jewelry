...
export default function HistoryScreen() {
  ...
  const [statusFilter, setStatusFilter] = React.useState<StatusFilter>('SELESAI');

  React.useEffect(() => {
    if (filter) {
      if (filter === 'ditugaskan') setStatusFilter('DITUGASKAN');
      ...
      <Modal visible={filterOpen} transparent animationType="fade" onRequestClose={() => setFilterOpen(false)}>
        <View style={styles.modalBackdrop}>
          <View style={styles.modalCard}>
            ...
            {(['SEMUA','DITUGASKAN','SELESAI','VERIFIKASI','BATAL'] as StatusFilter[]).map((s) => (
